...
def getFullCustomer(customer_id):
    ...
    tmp_customer = Customer(ID=customer[0], Firstname=customer[1] + 'a', Lastname=customer[2], Age=customer[3], Sex=customer[4], Street=customer[5], Zip=customer[6], City=customer[7], Nationality=customer[8], IMSIPtr=customer[9], IMEIPtr=customer[10], SubscriptionPtr=customer[11], Email=customer[12], Password=customer[13])
